...
import (
	...
	"github.com/jonfriesen/simple-sso/pkg/providers/memory"
...
func main() {
	...
	err = http.ListenAndServeTLS(":8081", memory.BaseConf.SSLCertPath, memory.BaseConf.SSLKeyPath, nil)
	if err != nil {
